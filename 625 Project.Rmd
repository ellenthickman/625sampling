...
B. Calculate 
```{r}
regcounts$zone_size <- sum(regcounts$Count) / regcounts$m_h_pair; regcounts
```
...
regcounts %>%
  select(Region, Count, m_h, zone_size, f_i) # stratum-level first-stage fraction: f_h^ = m_h/m_h
