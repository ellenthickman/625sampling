...
4. Compute your zone size (Fractional intervals) for systematic PPeS sampling within each of the 9 strata
A. Zone size
$$
...
5. Select the allocated number of schools within each stratum using PPeS sampling using systematic selection based on the fractional intervals (Zone size) 
```{r}
...
```
6. Report first-stage sampling fraction (f) within each of the nine strata under PPes
